      ...
      <div class="row align-items-center">
        ...
        <?php
          ...
          if (isset($_POST['submit'])) {
            ...
            $import=$_POST['import'];
            $amount_product=$data['amount_product']+$import;
            $user_id=$_SESSION['user_id'];
            $amount=$dataFruit['amount']+$import;
            $branch_id=$_SESSION['branch_id'];
          //  echo $import."<br>".$amount_product."<br>".$user_id."<br>".$amount."<br>".$id."<br>".$_SESSION['branch_id'];

            $query = "INSERT INTO warehouse (amount_product, import, fruit_id, user_id, warehouse_id)
             VALUES ('$amount_product','$import','$id','$user_id','$branch_id')";
             echo "$query";
        ...
        <div class="col">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-8">
              <label for="inputEmail4">นำเข้า</label>
              <input type="text" class="form-control" id="inputEmail4" name="import">
            </div>
