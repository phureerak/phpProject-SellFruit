  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="infoProfile.php">infoProfile</a>
        <a class="dropdown-item" href="edituser.php?id=<?php echo $_SESSION['user_id'] ?>">Edit Profile</a>
        <a class="dropdown-item" href="../changePass.php">ChangePassword</a>
      </div>
      </li>
      <a class="nav-item nav-link alert-warning " href="" data-toggle="modal" data-target="#exampleModal"> Logout</a>
